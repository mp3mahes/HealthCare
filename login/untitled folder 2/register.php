...
<tr>
<td><button type="submit" name="btn-signup">Sign In Here</button></td>
</tr>
<tr>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Register Using the following</h3>
                        		</div>
                            ...
                            <div class="form-bottom">
			                    <form role="form" method="post" class="login-form">
			                    	<div class="form-group">
                                        ...
                                        <input type="text" name="uname" placeholder="Enter a new Username" class="form-username form-control" id="form-username">
			                        </div>
			                        <div class="form-group">
			                    		<label class="sr-only" for="form-username">Username</label>
