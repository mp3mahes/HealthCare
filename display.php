...
<div id="header" class="container">
    ...
    <div id="menu">
        <ul>
            <li class="current_page_item"><a href="home.php" accesskey="1" title="">Home</a></li>
            <li><a href="events.php" accesskey="2" title="">Events</a></li>
            <li><a href="maps.php" accesskey="3" title="">Maps</a></li>
            <li><a href="contact.php" accesskey="5" title="">Contact Us</a>
...
<div id="wrapper">
    <div id="welcome" class="container">
        ...
        <h2>Hi' <?php echo $userRow['user_name']; ?> &nbsp;<a href="home.php?display"> See Your Recorded Data</a><h2>
            <br>
            
        <h2>Welcome! <?php echo $userRow['user_name']; ?> <span class="byline">Please Enter your details</span></h2>
...
<tr>
                        ...
                        <td><input type="text" name="city" value="" size="25" />
                   ...
                   <tr>
                        <td ><font color="red"> * </font>Maritial Status: </td>
                        <td><input type="text" name="maritial_status" value="" size="25" /></td>
                        
                   </tr>
                   <tr>
                        <td ><font color="red"> * </font>Insurance: </td>
...
<tr>
                        <td ><font color="red"> * </font>Chief Complain Keywords: </td>
